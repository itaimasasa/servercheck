...
for server in Tservers:
    ...
    for file in listT:
        if (file == 'jkp'):# 1 value
            ...
            if user == 3:
                print('Production : no access to the folder\n')
                newtextfile.write('Production : no access to the folder\n')
                Prod.write('Production : no access to the folder\n')
        ...
        if (file == 'jki'):# 2 value
            ...
            if user == 3 :
                print('Integration : no access to the folder\n')
                newtextfile.write('Integration : no access to the folder\n')
                Prod.write('Integration : no access to the folder\n')
            else:
                #dfiC['Integration'].append(user)
